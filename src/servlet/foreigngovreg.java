...
/**
 * Servlet implementation class foreigngovreg
 */
@WebServlet("/foreigngovreg")
public class foreigngovreg extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public foreigngovreg() {
        super();
				...
				while((part=mp.readNextPart())!=null)
				{
		       	...
		       	try
		       	{
		       		String status="request";
		       		 ...
		       		 con=dbconn.create();
		       		 PreparedStatement ps=con.prepareStatement("INSERT INTO globalinvest.`foreigngov` VALUES(id,?,?,?,?,?,?)");
		       		...
		       		response.sendRedirect("foreigngov.jsp");
