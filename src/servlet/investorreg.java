...
/**
 * Servlet implementation class investorreg
 */
@WebServlet("/investorreg")
public class investorreg extends HttpServlet {
				...
				while((part=mp.readNextPart())!=null)
				{
		       	...
		       	try
		       	{
		       		...
		       		String status2="request";
		       		 con=dbconn.create();
		       		 PreparedStatement ps=con.prepareStatement("INSERT INTO globalinvest.`investors` VALUES(id,?,?,?,?,?,?,?,?)");
		       		 ...
		       		 ps.setString(8,status2);
		       		
		       		 
		       		 dd=ps.executeUpdate();	
		     
		       	
		       		response.sendRedirect("investorreg.jsp");
